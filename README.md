...
echo "<h1>Guess a number game</h1>" > public_html/index.html
...
do
        ...
        if [ $i -eq $numm ]
                then
                        echo "<h1>YOU WIN</h1>" >> public_html/$i.html
                else
                        if [ $i -gt $numm ]
                        then
                                echo "<h1>number is less</h1>" >> public_html/$i.html
                        else
                                echo "<h1>number is greater</h1>" >> public_html/$i.html
                fi
        fi
